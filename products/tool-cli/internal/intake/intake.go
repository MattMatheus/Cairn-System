...
func RenderArtifact(artifact Artifact) string {
	...
	builder.WriteString("\n## Method\n\n")
	builder.WriteString("- Normalized into markdown for Cairn review.\n")
	builder.WriteString("- Requires human triage before memory-cli promotion.\n")
	builder.WriteString("\n## Review Scaffold\n\n")
	...
	builder.WriteString("\n### Promotion Notes\n\n")
	builder.WriteString("- memory-cli candidate: no\n")
