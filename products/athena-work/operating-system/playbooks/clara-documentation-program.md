...
- Source-of-truth artifacts are available:
  ...
  - implementation stories in `products/athena-work/delivery-backlog/engineering/done/`
  - QA evidence in `products/athena-work/delivery-backlog/engineering/done/`
- Documentation backlog stories exist in `products/athena-work/delivery-backlog/engineering/intake/` or `products/athena-work/delivery-backlog/engineering/active/`.
...
4. Clara validates docs with `products/athena-work/tools/run_doc_tests.sh` and ensures publish workflow eligibility.
...
- Required outputs:
  ...
  - cross-check with release bundle in `products/athena-work/operating-system/handoff/`
...
## References
- `products/athena-work/staff-personas/Technical Writer - Clara.md`
