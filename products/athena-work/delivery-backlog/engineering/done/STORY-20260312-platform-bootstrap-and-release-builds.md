...
## Problem Statement
- AthenaPlatform had no canonical bootstrap entrypoint and no supported CI path for building distributable binaries from the unified repo. That made setup slower and alpha distribution harder than necessary.
...
## Acceptance Criteria
1. AthenaPlatform has a canonical bootstrap command that prepares repo-local runtime folders and validates the Go toolchain.
