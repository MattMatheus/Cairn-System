# AthenaWork Validation Surface Status

This file classifies AthenaWork validation scripts that still exist under `products/athena-work/tools/`.
...
- `test_athenause_registry_validation.sh`
