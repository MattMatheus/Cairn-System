...
council_doc="$root_dir/docs/operator/work-harness/process/RESEARCH_COUNCIL_BASELINE.md"
...
doc_assert_contains "$council_doc" "CAIRN_DIRECTION_CONFIRMATION_ID" "Council doc requires explicit direction confirmation evidence"
