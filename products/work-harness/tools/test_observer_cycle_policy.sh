...
doc_assert_contains "$root_dir/docs/operator/work-harness/process/STAGE_EXIT_GATES.md" "Cycle Closure Gate (Observer + Commit)" "Stage exits include cycle closure gate"
