...
go_mods=(
  "$root_dir/products/memory-cli/go.mod"
  "$root_dir/products/tool-cli/go.mod"
)
...
Required: Go >= $required_version (from products/memory-cli/go.mod and products/tool-cli/go.mod)
