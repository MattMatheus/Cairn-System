...
gate_script="$root_dir/products/work-harness/tools/check_security_nonce_gate.sh"
nonce_script="$root_dir/products/work-harness/tools/generate_security_nonce.sh"
contracts_file="$root_dir/products/work-harness/operating-system/contracts/SECURITY_BACKING_CONTRACT_PATHS.txt"
policy_file="$root_dir/products/work-harness/operating-system/contracts/SECURITY_CHANGE_CONTROL_POLICY_V1.md"
...
doc_assert_contains "$gate_script" "CAIRN_SECURITY_CHANGE_NONCE" "Gate requires nonce input"
doc_assert_contains "$gate_script" "CAIRN_SECURITY_CHANGE_OTP_PRIMARY" "Gate requires primary OTP input"
doc_assert_contains "$gate_script" "CAIRN_SECURITY_CHANGE_OTP_SECURITY" "Gate requires security OTP input"
doc_assert_contains "$gate_script" "CAIRN_SECURITY_GATE_WINDOW_MINUTES" "Gate supports tunable nonce window"
...
doc_assert_contains "$nonce_script" "CAIRN_SECURITY_CHANGE_NONCE" "Nonce generator emits export guidance"
