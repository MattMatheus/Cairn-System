...
source "$root_dir/products/work-harness/tools/lib/doc_test_harness.sh"

api_file="$root_dir/products/work-harness/ui/local_control_plane_api.py"
ui_file="$root_dir/products/work-harness/ui/index.html"
gen_tool="$root_dir/products/work-harness/tools/generate_launch_authorization_package.sh"
val_tool="$root_dir/products/work-harness/tools/validate_launch_authorization_package.sh"
