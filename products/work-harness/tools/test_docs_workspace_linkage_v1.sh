...
api_file="$root_dir/products/work-harness/ui/local_control_plane_api.py"
...
assert "products/work-harness/delivery-backlog/engineering/active/README.md" in paths
assert "products/work-harness/delivery-backlog/engineering/done/STORY-20260227-docs-linkage-and-sync-projection-hardening-v1.md" in paths
assert "products/work-harness/delivery-backlog/engineering/done/STORY-20260227-left-anchored-landscape-layout-v1.md" in paths
assert "products/work-harness/delivery-backlog/engineering/done/STORY-20260227-kanban-entity-relationship-implementation-v1.md" in paths
