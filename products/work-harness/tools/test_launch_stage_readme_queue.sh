...
expected_story="products/work-harness/delivery-backlog/engineering/active/STORY-TEST-README-ORDER-B.md"
...
output="$(CAIRN_REQUIRED_BRANCH="$current_branch" "$launch_script" engineering)"
