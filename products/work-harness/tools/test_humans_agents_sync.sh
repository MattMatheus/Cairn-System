...
watched=(
  ...
  "products/work-harness/operating-system/README.md"
  ...
  "products/work-harness/delivery-backlog/engineering/intake/STORY_TEMPLATE.md"
  "products/work-harness/delivery-backlog/engineering/intake/BUG_TEMPLATE.md"
  "products/work-harness/delivery-backlog/architecture/intake/ARCH_STORY_TEMPLATE.md"
  ...
  "products/work-harness/stage-prompts/active/cycle-seed-prompt.md"
)
