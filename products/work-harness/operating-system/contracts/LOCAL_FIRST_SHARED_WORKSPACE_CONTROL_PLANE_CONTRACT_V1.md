...
## Scope
Defines authoritative state entities, transition API semantics, and immutable observer-linked event model for work harness local-first shared workspace workflows.
