...
This folder is part of the active work harness path because observer output is required for cycle closure.

## Command
- `products/work-harness/tools/run_observer_cycle.sh --cycle-id <cycle-id> [--story <path>]`
