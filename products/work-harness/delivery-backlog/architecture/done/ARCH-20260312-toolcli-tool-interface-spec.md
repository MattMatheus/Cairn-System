# Architecture Story: Decide tool-cli formal tool interface specification slice

## Metadata
- `id`: ARCH-20260312-toolcli-tool-interface-spec
...
## Decision Scope
- Decide whether the next post-registry tool-cli slice should be a bounded context/schema enhancement or a formal tool interface specification effort.
...
## Acceptance Criteria
1. The decision explicitly chooses the next tool-cli slice and explains why the alternate path is deferred.
...
## QA Focus
- Check that the decision stays within tool-cli v1 scope and does not implicitly authorize execution/runtime expansion.
