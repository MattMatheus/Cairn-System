...
description: work harness extension that organizes durable development knowledge as a traversable graph with progressive disclosure and canonical source references.
...
work harness should treat development knowledge as a graph, not a flat pile of prompts and docs. The graph gives agents a bounded way to move from repo orientation to action, while [[CANONICAL_SOURCE_REGISTRY]] records pin external tool semantics to official vendor docs.

## Intended Audience

- humans shaping work harness's documentation model
- stage-agent authors
- maintainers of process, architecture, and operational docs

## Preconditions

- work harness remains primarily a development-work system
...
work harness should split development context into three layers:
...
For work harness, the first graph domains should be:
...
description: How work harness agents decide what to run to prove a code change is correct.
doc_type: heuristic
status: active
domain: workflow
canonical_sources:
...
This keeps work harness aligned with bounded attention instead of "load everything."
...
- [AGENTS.md](/home/matt/Workspace/repos/trusted/Cairn/products/work-harness/AGENTS.md)
- [HUMANS.md](/home/matt/Workspace/repos/trusted/Cairn/products/work-harness/HUMANS.md)
- [DEVELOPMENT_CYCLE.md](/home/matt/Workspace/repos/trusted/Cairn/products/work-harness/DEVELOPMENT_CYCLE.md)
