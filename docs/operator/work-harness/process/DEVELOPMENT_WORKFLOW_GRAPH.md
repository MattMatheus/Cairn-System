...
description: Map of the first work harness development-work subgraph covering cycle navigation, stage contracts, handoffs, verification, and commit invariants.
doc_type: moc
status: draft
domain: process
---
...
This MOC is the entry point for work harness development execution. It routes agents and operators to the minimum process nodes needed to choose the next action, verify work, hand off safely, and close a cycle without rereading every process document.
...
- the task is part of the work harness development cycle
...
- `docs/operator/work-harness/process/README.md`
