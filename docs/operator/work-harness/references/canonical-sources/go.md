---
title: Go
description: Official Go documentation record for language, module, toolchain, and test-command semantics used by work harness.
...
avoid_when:
  - the task is only about work harness process
notes:
