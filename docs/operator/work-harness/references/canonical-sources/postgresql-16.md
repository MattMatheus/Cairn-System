---
title: PostgreSQL 16
description: Official PostgreSQL 16 docs record for SQL semantics, administration behavior, and feature expectations in work harness environments.
...
avoid_when:
  - the task is only about work harness workflow rules
notes:
...
Use the PostgreSQL 16 manual when work harness tasks depend on database semantics or Postgres administration details.
