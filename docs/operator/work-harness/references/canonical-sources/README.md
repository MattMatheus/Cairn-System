...
description: Registry of official vendor-doc records used by work harness agents for external tool semantics.
doc_type: index
status: draft
---
...
This folder holds official external source records. Each file identifies the vendor docs work harness agents should trust for a tool, plus the version policy that controls retrieval.

## Intended Audience

- work harness maintainers
- agent authors
