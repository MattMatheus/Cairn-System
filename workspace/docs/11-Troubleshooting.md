...
- Action: reconcile `products/work-harness/operating-system-vault/*`, `workspace/AGENTS.md`, `workspace/docs/HUMANS.md`, and `workspace/docs/*` in one change set.
...
- Action: run `tools/migration/prune_user_content.sh --export-zip /writable/path/work-harness-user-content-backup.zip`.
